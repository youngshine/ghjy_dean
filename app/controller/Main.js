...
Ext.define('Youngshine.controller.Main', {
	...
	toPinyin: function(input){
		...
		var PinYin =  ConvertPinyin(input)
		return PinYin;
		
		// 汉字转拼音
		function ConvertPinyin(xingming) {
		    var len = xingming.length; console.log(len)
		    var I1 = "";
		    var reg = new RegExp('[a-zA-Z0-9\- ]');
		    for (var i = 0; i < len; i++) {
		        var val = xingming.substr(i, 1);
